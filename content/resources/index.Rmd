...
3. [Big Book of R](https://www.bigbookofr.com/) -- one stop shopping for pretty much any R-related book that's out there (categorized by topic and searchable)
:::
...
1. 5-course [Data Science Specialization](https://github.com/uo-datasci-specialization) offered by UO College of Education, led by [Daniel Anderson](https://education.uoregon.edu/people/faculty/daniela). Cannot recommend highly enough! `r emo::ji("star")` `r emo::ji("star")` `r emo::ji("star")` `r emo::ji("star")` `r emo::ji("star")`

2. UO Psych Data Analysis Sequence (PSY611, PSY612, PSY613), led by [Sara Weston](https://psychology.uoregon.edu/profile/sweston2/) and [Elliot Berkman](https://psychology.uoregon.edu/profile/berkman/). See example course websites [here](https://github.com/uopsych) -- you will learn a TON.
