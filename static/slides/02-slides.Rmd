...
Vectors can be indexed numerically, starting with 1 (not 0). We can extract certain elemnts by from a vector by putting the index of their position inside brackets `[]`. 
