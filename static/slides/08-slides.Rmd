...
This means you will need to reshape your data in order to get in in a tidy format. 
...
Our example data is built into to the `tidyverse` package. 
...
**.green[values_to]**  .green[= A string specifying the name of the column to create from the data stored in cell values]
...
Here's a different dataset (`table2`) that needs to be reshaped to a wider format. 
...
.content[
<br><br><br><br><br><br><br><br><br><br>
To tidy this up, we need to pieces of information
