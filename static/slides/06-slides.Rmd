...
Ok, now back to `ggplot`. We'll be using the pipe operator from here on out. 

--
***

The basic idea is that we want to take our data and map it onto physical space using geometric objects or geoms. 
...
.right-plot[
```{r penguins-hist-basic-out, ref.label="penguins-hist-basic", echo=FALSE, fig.dim=c(4.8, 4.5), out.width="100%", warning=FALSE, message=FALSE}
```
]
...
.right-plot[
```{r penguins-hist-bins-out, ref.label="penguins-hist-bins", echo=FALSE, fig.dim=c(4.8, 4.5), out.width="100%", warning=FALSE, message=FALSE}
```
]
...
.right-plot[
```{r penguins-hist-fill-out, ref.label="penguins-hist-fill", echo=FALSE, fig.dim=c(4.8, 4.5), out.width="100%", warning=FALSE, message=FALSE}
```
]
...
.right-plot[
```{r penguins-point-fixed-out, ref.label="penguins-point-fixed", echo=FALSE, fig.dim=c(4.8, 4.5), out.width="100%", warning = FALSE, message = FALSE}
```
]
...
.right-plot[
```{r penguins-point-color-out, ref.label="penguins-point-color", echo=FALSE, fig.dim=c(4.8, 4.5), out.width="100%", warning = FALSE, message = FALSE}
```
]
...
.right-plot[
```{r penguins-point-red-out, ref.label="penguins-point-red", echo=FALSE, fig.dim=c(4.8, 4.5), out.width="100%", warning = FALSE, message = FALSE}
```
]
...
.right-plot[
```{r penguins-yt-q1-out, ref.label="penguins-yt-q1", echo=FALSE, fig.dim=c(4.8, 4.5), out.width="100%", warning = FALSE, message = FALSE}
```
]
]
...
.right-plot[
```{r penguins-yt-q2-out, ref.label="penguins-yt-q2", echo=FALSE, fig.dim=c(4.8, 4.5), out.width="100%", warning = FALSE, message = FALSE}
```
]
...
.right-plot[
```{r penguins-point-facet-out, ref.label="penguins-point-facet", echo=FALSE, fig.dim=c(4.8, 4.5), out.width="100%", warning = FALSE, message = FALSE}
```
]
