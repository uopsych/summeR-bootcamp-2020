...
1. Inside the code chunk provided under `"Your Turn 1"`, create a variable called `var_1` that is equal to 4.

2. Then create a variable called `var_2` that is `var_1` raised to the power of 6. Print the results.
